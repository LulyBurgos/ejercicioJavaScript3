...
function despedir() {
  ...
  // 5.3 Crea una función recursiva llamada `factorial` que calcule el factorial
  // de un número. El factorial de n (n!) es el producto 
  //de todos los números enteros positivos menores o iguales a n.
  ...
  // 5.4 Escribe una función recursiva que calcule la potencia de
  // un número dado el exponente. Por ejemplo: `potencia(2, 3) -> 8`
